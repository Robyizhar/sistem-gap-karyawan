    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group mb-3">
                ...
                <div class="d-flex">
                    <input style="background-color: #e9e7e7; cursor: not-allowed" readonly value="{{ !isset($data) ? old('np') : old('np', $data->np) }}" type="text" id="nama_lengkap" class="form-control">
                </div>
                ...
                @if (isset($index_penilaians))
                    @foreach ($index_penilaians as $key => $value)
                        @if ($key == $penilaian->question)
                            <label class="mr-3">
                                <input type="radio" class="" id="item_checkbox" disabled name="penilaian[{{$penilaian->question}}]" value="1"
                                {{ !isset($index_penilaians) || isset($index_penilaians) && $value == 1 ? 'checked' : '' }}>
                                <span class=""> {{ 'Ya' }} </span>
                            </label>
                            <label class="mr-3">
                                <input type="radio" class="" id="item_checkbox" disabled name="penilaian[{{$penilaian->question}}]" value="0"
